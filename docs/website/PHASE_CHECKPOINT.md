...
本文件记录 Core Website MVP Freeze Audit 的阶段性整理结果。它是 Git checkpoint，不代表官网已经部署、SEO 已完成或所有页面已经通过发布验收。
...
- English 是 default locale，使用根路径及无 locale 前缀的英文页面：`/`、`/features`、`/privacy`、`/platforms`、`/templates`、`/faq`、`/support`、`/terms`。
- 中文使用 `/zh-CN` 前缀：`/zh-CN`、`/zh-CN/features`、`/zh-CN/privacy`、`/zh-CN/platforms`、`/zh-CN/templates`、`/zh-CN/faq`、`/zh-CN/support`、`/zh-CN/terms`。
...
当前阶段完成：Core Website MVP Freeze Audit。下一阶段：SEO Finalization。
